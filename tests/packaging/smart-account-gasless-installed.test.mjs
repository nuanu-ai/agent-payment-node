...
test("installed CLI and 91-tool MCP discover Base Smart Account gasless without state or external effects", async () => {
  ...
  try { const tools = await connection.client.listTools(); assert.equal(tools.tools.length, 91);

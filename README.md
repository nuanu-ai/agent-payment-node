...
APN 0.5.17 is the ordinary release build for Apple Silicon macOS. It combines
...
only an exact verified 0.5.17 archive or installation for the new commands.
...
an APN 0.5.17 capability with separate per-network mainnet acceptance.
...
reports `0.5.17` before using the commands described for this release.

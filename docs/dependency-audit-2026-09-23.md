...
The npm advisory remains **five high affected records** and C1-11 remains open pending an upstream fixed/removing dependency release or broader APN runtime coverage. A package lock refresh or SDK upgrade must repeat the boundary and helper behavior tests.

...
export type CommandRequest = {
    ...
    readonly command: "stargate.token.prepare";
    readonly profile: string;
    readonly amountAtomic: string;
    ...
    readonly command: "swap.uniswap.prepare";
    readonly profile: string;
    ...
    readonly deadline: number;
    readonly maxApprovalGasLimit: string;
    readonly maxSwapGasLimit: string;
    readonly maxCleanupGasLimit: string;
    readonly maxFeePerGas: string;
    readonly maxPriorityFeePerGas: string;
    ...
    readonly command: "swap.orca.prepare";
    readonly profile: string;
    readonly quoteHash: string;
    readonly idempotencyKey: string;
} | {
    readonly command: "swap.orca.status" | "swap.orca.approve" | "swap.orca.execute";
    readonly operationId: string;
} | {
    ...
    readonly command: "oneclick.source.status";
    readonly operationId: string;
} | {
    readonly command: "circle.approval.prepare";
    readonly profile: string;
    readonly approvalCapAtomic: string;
    readonly maxGasLimitAtomic: string;
    readonly maxFeePerGasWei: string;
    ...
    readonly command: "circle.approval.execute" | "circle.approval.status";
    readonly operationId: string;
} | {
    readonly command: "circle.source.submit";
    readonly profile: string;
    readonly expectedPayer: string;
    ...
    /** Explicit Linea native, Unichain native or USDC, or Polygon USDC prepare read batching; default is scalar RPC. */

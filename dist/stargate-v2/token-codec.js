...
export function address(value) { try {
...
export function hex32(value) { if (typeof value !== "string" || !HASH.test(value))
    return fail("APN_RPC_PROTOCOL", "hash"); return value; }
export function quantity(value) { if (typeof value !== "string" || !/^0x(?:0|[1-9a-f][0-9a-f]*)$/u.test(value))
    return fail("APN_RPC_PROTOCOL", "quantity"); return BigInt(value); }
export function packetBinding(payload) {

import { decodeEventLog, decodeFunctionResult, encodeFunctionData, getAddress, keccak256, pad, parseTransaction, recoverTransactionAddress, } from "viem";
...
import { CODE, LAYERZERO_ENDPOINT_V2, STARGATE_TOKEN_DESTINATION_EID, STARGATE_TOKEN_DESTINATION_EXECUTOR, STARGATE_TOKEN_DESTINATION_MESSAGING, STARGATE_TOKEN_DESTINATION_POOL, STARGATE_TOKEN_DESTINATION_TOKEN, STARGATE_TOKEN_SOURCE_CHAIN, STARGATE_TOKEN_SOURCE_EID, STARGATE_TOKEN_SOURCE_EXECUTOR, STARGATE_TOKEN_SOURCE_MESSAGING, STARGATE_TOKEN_SOURCE_POOL, STARGATE_TOKEN_SOURCE_TOKEN, address, fail, hex32, packetBinding, quantity, uint, } from "./token-codec.js";
export function rpcEnvelope(envelope) {
...
export function sourceReceipt(op, receipt) {
...
export function validateDestination(op, source, e) {
...
export async function readExecutorCap(call, tag) {
...
export async function requoteSend(call, sendParam, tag) {
...
export async function readPoolConfig(call, chain, pool, token, eid, tag) {
...
export async function readAllowance(call, owner, tag) {
...
export async function readTokenBalance(call, token, owner, tag) {

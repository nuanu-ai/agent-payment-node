...
import { canonicalProviderRecoveryToken, createProviderEffectReference, } from "./provider-direct-recovery.js";
...
export class ProviderDirectRequestRecoveryService {
    ...
    async recover(operationIdInput, providerRequestIdInput) {
        ...
        return await this.context.state.withLocks([
            ...
            if (operation.terminal || operation.state !== "ambiguous_effect" || operation.transactionHash !== undefined ||
            ...
            const duplicate = (await this.context.state.listAllOperations()).find((candidate) => candidate.operationId !== operationId &&
    ...
    async persistRecoveredReference(operation, recoveryToken) {
        const transition = {
...
//# sourceMappingURL=provider-direct-request-recovery.js.map
...
export declare class X402Lifecycle {
    ...
    protected transition(operation: X402OperationRecord, state: X402State, additions?: Partial<Pick<X402OperationRecord, "signatureHash" | "paymentPayloadHash" | "paymentHeaderHash" | "paymentContextHash" | "attempts" | "settlementResponseObservation" | "transactionHint" | "authorizationUsedScan" | "settlementEvidence" | "unusedExpiryEvidence" | "resultLink" | "receiptLink">>): Promise<X402OperationRecord>;
}

...
export function installRuntimeDependencyBoundary() {
    registerHooks({ resolve(specifier, context, nextResolve) {
            if (blocked.has(specifier) || blockedPath.test(specifier))
                throw new Error("APN dependency boundary rejected Solana decoder");
...
//# sourceMappingURL=runtime-dependency-boundary.js.map
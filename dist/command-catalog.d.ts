...
export declare const COMMAND_MANIFEST: {
    ...
    readonly product_version: "0.2.6";
...
export declare function renderReadmeCommandReference(): string;
...
export declare function renderHelp(path: readonly string[]): string;

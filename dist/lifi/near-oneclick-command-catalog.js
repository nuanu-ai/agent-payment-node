import { createCliHandoff } from "../cli-handoff.js";
...
const output = { contract: "apn.cli.v1", success_exit: 0, failure_exit: 1,
    success: "OneClick source state saved.", failures: ["Classified APN failure; no automatic resend."] };
...
export const ONECLICK_COMMANDS = [
...
function u(o, key) { return bridgeUint(v(o, key), false, "APN_INVALID_INPUT").toString(); }
export function bindOneClickCommand(path, o) {
    if (path === "oneclick source status")
        return { command: "oneclick.source.status", operationId: bridgeHash(v(o, "--operation"), "APN_INVALID_INPUT") };
    if (path !== "oneclick source submit")
        throw new Error("Unknown 1Click command");
...
export function oneClickSubmitHandoff(r) {
...
//# sourceMappingURL=near-oneclick-command-catalog.js.map
 ...
 */
export const BRIDGE_FEE_HEADROOM_POLICY = "apn.bridge-fee-headroom.v1";
 ...
 */
export function bridgeHeadroomWei(quotedWei, code = "APN_RPC_PROTOCOL") {
    const quoted = bridgeUint(quotedWei, false, code);
    return ((quoted * BigInt(10_000 + BRIDGE_FEE_HEADROOM_BPS) + 9999n) / 10000n).toString();
}

...
export async function assemblePermit2Payment(plan, signer) {
...
async function requireSigner(typedData, signature, payer) {
    ...
    try {
        ...
        throw new ApnError("APN_NATIVE_PROTOCOL", "The local signature does not recover.");
    }

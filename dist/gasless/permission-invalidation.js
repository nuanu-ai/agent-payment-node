...
export function assertGaslessPermissionClosure(op, s) {
    ...
    if (o?.status !== "permissions_invalidated" || o.permissionInvalidation === undefined ||
        ...
        o.reason !== GASLESS_PERMISSIONS_INVALIDATED || o.evidenceHash !== hashObject(o.permissionInvalidation))
        invalid();
    return validateGaslessPermissionInvalidation(op.intent, b.materialHash, o.permissionInvalidation);
}
function invalidated(intent, account) {

...
export function gaslessDecimal(value, positive = false) {
    if (typeof value !== "string" || !/^(?:0|[1-9][0-9]{0,71})(?:\.[0-9]{1,6})?$/u.test(value))
        gaslessFailure("APN_INVALID_INPUT", "gasless_six_decimal_USDC");
    const [whole, fraction = ""] = value.split(".");
    const n = (BigInt(whole) * 1000000n + BigInt(fraction.padEnd(6, "0"))).toString();

...
export function opaqueHttpResult(raw) {
    if (raw.status < 200 || raw.status >= 300)
        return undefined;
    const contentTypes = raw.rawHeaderPairs.filter(([name]) => name.toLowerCase() === "content-type");
    if (contentTypes.length > 1)
        throw invalid("Seller returned duplicate Content-Type headers.");
...
export function parseResultMediaType(value) {
...
//# sourceMappingURL=x402-opaque-result.js.map
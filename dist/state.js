...
import { x402TransactionHintSourceBindingHash, validateX402Operation, validateX402Receipt, validateX402Result, } from "./x402-state-integrity.js";
...
export class StateStore extends SecureStateStore {
    ...
    async loadX402Operation(profileHash, operationId) {
        ...
        if (value === null)
            return null;
        if (PROVIDER_X402_OPERATION_SCHEMAS.has(storedSchema(value)))
            return null;
...
function storedSchema(value) { return isPlainRecord(value) ? value.schemaVersion : undefined; }

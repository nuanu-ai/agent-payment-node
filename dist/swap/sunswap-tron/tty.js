...
export class TtySunSwapApproval {
    store;
    clock;
    options;
...
export async function sunSwapApprovalScreen(store, intent) {
    ...
    const r = intent.gasOrEnergy, trx = (key) => `${chainDisplay(required(r, key), 6)} TRX (${required(r, key)} SUN)`;

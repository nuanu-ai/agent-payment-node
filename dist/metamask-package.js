...
export const METAMASK_AGENT_WALLET_VERSION = "6.1.5";
export const METAMASK_AGENT_WALLET_BIN = "dist/index.js";
export const METAMASK_AGENT_WALLET_INTEGRITY = "sha512-ZvLxHVCExbh2qsjTuLXXyjTXKc4kGQRuoGgW8ui52K+w4eq9R6XwtrvSrCJJh6/c5zzIHqMC1yi2kgoUBs+z8Q==";
export const METAMASK_AGENT_WALLET_SHASUM = "6fcfb2d3b376a9495ef053b2d6b98cecf842e29a";
export const METAMASK_PROCESS_TIMEOUT_MS = 30_000;
export const METAMASK_FOREGROUND_TIMEOUT_MS = 10 * 60_000;
export async function resolveMetaMaskBin() {
    ...
    if (value.name !== "@metamask/agent-wallet" || value.version !== METAMASK_AGENT_WALLET_VERSION ||
    ...
    if (!script.startsWith(`${packageRoot}/`))
        throw providerProtocol();
    return script;
}
...
//# sourceMappingURL=metamask-package.js.map
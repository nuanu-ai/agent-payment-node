...
const scalarTypes = new Set(["string", "profile", "provider_id", "provider_auth_method", "positive_integer", "https_url", "address", "decimal_usdc", "atomic_usdc", "wei", "operation_id", "transaction_hash", "idempotency_key", "integer_seconds"]);

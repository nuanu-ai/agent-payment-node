...
const scalarTypes = new Set(["string", "profile", "provider_id", "positive_integer", "https_url", "address", "decimal_usdc", "atomic_usdc", "wei", "operation_id", "idempotency_key", "integer_seconds"]);

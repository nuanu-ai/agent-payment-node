...
export class RuntimeContext {
    ...
    constructor(dependencies) {
        ...
        if (dependencies.relayArbitrumDepositDispatch !== undefined)
            this.relayArbitrumDepositDispatch = dependencies.relayArbitrumDepositDispatch;

...
declare const deployment: {
    ...
    ownerDesignationCode: Hex;
    ownerDesignationCodeHash: `0x${string}`;
    facilitatorUrl: string;
    facilitatorOrigin: string;
    facilitatorEndpointHash: string;
    facilitatorAddresses: readonly ["0xb4827a2a066cd2ef88560efdf063dd05c6c41cc7"];
};
...
export declare function saRegistry(chainId: number): SmartAccountGaslessDeployment;
export {};

...
export const SA_CHAIN_ID = 8453 as const;
export const SA_TTL_MS = 300_000;
export const SA_MIN_REMAINING_MS = 30_000;
export const SA_MAX_UINT = (1n << 256n) - 1n;
export const SA_ZERO_ADDRESS = "0x0000000000000000000000000000000000000000" as Address;
export const SA_PROTOCOL_NAMES = ["manager", "value", "amount", "calldata", "timestamp", "redeemer",
  "period", "nonce", "delegate"] as const;
...
export interface SmartAccountGaslessRequirements {
  ...
  readonly extra: { readonly assetTransferMethod: "erc7710"; readonly facilitatorAddresses: readonly Address[] };
}
...
export interface SmartAccountGaslessPayload {
  ...
  readonly payload: { readonly delegationManager: Address; readonly delegator: Address; readonly permissionContext: Hex };
}
...
export type SmartAccountGaslessState = "awaiting_approval" | "execution_pending" | "material_pending" |
  "material_sealed" | "exposure_pending" | "verified_pending" | "dispatch_pending" | "submitted_pending" |
  "unknown_finality" | "failed_before_effect" | "expired_unused" | "completed";

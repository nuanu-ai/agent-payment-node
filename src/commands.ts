...
export type CommandRequest =
  ...
  | { readonly command: "gasless.balance"; readonly profile: string; readonly chainId: GaslessChainId }
  | { readonly command: "gasless.transfer.prepare"; readonly profile: string; readonly request: GaslessRequest; readonly idempotencyKey: string }

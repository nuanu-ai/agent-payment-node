...
import { USDT_GASLESS, type UsdtTransferPlan } from "./model.js";

/** Six-decimal display of an atomic USDT amount; exact, never rounded. */
export function usdtDisplay(atomic: bigint | string): string {
 ...
 */
export function usdtApprovalScreen(plan: UsdtTransferPlan, admission: UsdtGaslessAdmission, firstUse: boolean): readonly string[] {
  return [

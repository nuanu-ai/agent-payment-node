export type ErrorCode =
  | "APN_INVALID_INPUT"
  | "APN_ALLOWLIST_UNKNOWN_CHAIN"
  | "APN_ALLOWLIST_IDENTITY_INVALID"
  | "APN_ALLOWLIST_ASSET_NOT_FOUND"
  | "APN_ALLOWLIST_NOT_ADMITTED"
  ...
  | "APN_X402_CAP_EXCEEDED"
  | "APN_X402_PROFILE_LIMIT_EXCEEDED"
  | "APN_X402_OFFER_EXCEEDS_LIMIT"
  | "APN_X402_PAYMENT_AMBIGUOUS"
  | "APN_X402_SETTLEMENT_INVALID"
  | "APN_X402_RESULT_INVALID"
  | "APN_X402_RECOVERY_AMBIGUOUS"
  | "APN_RPC_CONFIG"
  | "APN_RPC_PROTOCOL"
  | "APN_RPC_AMBIGUOUS"
  | "APN_RPC_RATE_LIMITED"
  | "APN_RPC_BUDGET_EXCEEDED"
  | "APN_CHAIN_MISMATCH"
  | "APN_WALLET_MISMATCH"
  | "APN_WALLET_POLICY_REQUIRED"
  | "APN_FOREGROUND_AUTH_REQUIRED"
  | "APN_PROVIDER_UNAVAILABLE"
  | "APN_PROVIDER_CAPABILITY_UNAVAILABLE"
  | "APN_PROVIDER_PROTOCOL"
  | "APN_PROVIDER_SESSION_REQUIRED"
  | "APN_PROVIDER_EFFECT_UNAVAILABLE"
  | "APN_PROFILE_DRIFT"
  | "APN_PROFILE_REVISION_CONFLICT"
  | "APN_FOREGROUND_APPROVAL_REQUIRED"
  | "APN_WALLET_OVERFUNDED_FOR_UNATTENDED_X402"
  | "APN_INSUFFICIENT_USDC"
  | "APN_INSUFFICIENT_ASSET"
  | "APN_ASSET_MISMATCH"
  | "APN_ASSET_METADATA_REQUIRED"
  | "APN_FEE_BUDGET_EXCEEDED"
  | "APN_INSUFFICIENT_GAS"
  | "APN_PERMISSION_INACTIVE"
  | "APN_PERMISSION_ALLOWANCE_INSUFFICIENT"

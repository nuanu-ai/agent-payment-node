...
export const PERMIT2_CODE_HASH = "0x081beff14e75c5a5c1e60740445f58d54ba0fef228148a11d3e4287dc3551cbb" as Hex;
/** x402 Foundation exact Permit2 proxy; CREATE2, the same address and runtime code on every admitted chain. */
export const X402_EXACT_PERMIT2_PROXY = "0x402085c248EeA27D92E8b30b2C58ed07f9E20001" as Address;
/** The owner's x402 admission must carry exactly this mechanism pin; any other pin refuses. */
export const X402_PERMIT2_MECHANISM = { provider: "x402-exact-permit2", reference: X402_EXACT_PERMIT2_PROXY } as const;
...
export const X402_PERMIT2_ASSETS: readonly Permit2ListAsset[] = [{
  chain: "eip155:43114",
  chainId: 43114,
  networkName: "Avalanche C-Chain",
  token: "0x9702230A8Ea53601f5cD2dc00fDBc13d4dF4A8c7" as Address,
  symbol: "USDT",
  decimals: 6,
  tokenDomain: { name: "TetherToken", version: "1" },
  tokenDomainSeparator: "0xf6d4d20bf85d69d29f5cd682e5fb2884425e4aa291bb7318e203fd68c96cc0f4" as Hex,
  proxyCodeHash: "0xce6429c0bb49284660683287c0a8fe548a88379072327d026626909d202048b9" as Hex,
}];
 ...
 */
export const X402_PERMIT2_BLOCKED: readonly { readonly chain: string; readonly token: Address; readonly reason: "x402_permit2_facilitator_unavailable" }[] = [
  { chain: "eip155:1", token: "0xdAC17F958D2ee523a2206206994597C13D831ec7" as Address, reason: "x402_permit2_facilitator_unavailable" },
];

export function permit2ListAsset(chain: unknown): Permit2ListAsset | undefined {

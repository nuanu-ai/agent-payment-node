...
export const COMMANDS: readonly CommandDefinition[] = [
  ...
  command(
    ...
    "payment_prepare",
    "Reads Base evidence and durably freezes recipient, amount, nonce, fees, calldata and expiry without signing.",
    "none",
  ...
  command(
    ...
    [operationRequired, rpcRequired],
    "payment_submit",
    "After an exact foreground approval, signs and submits only the frozen transfer.",
    "foreground_tty",
    "Always requires the exact operation-bound phrase in foreground stdin/stderr TTYs.",
    directStates,
    [
      { command_path: ["operation", "status"], when: "To inspect any returned non-terminal state." },
      { command_path: ["operation", "resume"], when: "When documented durable recovery is permitted." },

...
export async function validateX402TerminalGraph(readJson: ReadJson, operation: X402OperationRecord): Promise<void> {
...
export function validateX402RecoveryReceiptAuthority(operation: X402OperationRecord, receipt: X402ReceiptRecord): void {
  if (

 ...
 */
export function mmRepriceWithinCap(value: unknown, request: MetaMaskGaslessRequest,
  binding: MetaMaskGaslessBinding, reason: MetaMaskGaslessFailureReason = "mm_gasless_quote_invalid"): MetaMaskGaslessQuote {

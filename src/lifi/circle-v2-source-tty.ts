...
export class TtyCircleV2SourceApproval implements CircleV2SourceApprovalPort {
  constructor(private readonly options: TtyTransferApprovalOptions = {}) {}
  async approve(p: Parameters<CircleV2SourceApprovalPort["approve"]>[0]): Promise<void> {

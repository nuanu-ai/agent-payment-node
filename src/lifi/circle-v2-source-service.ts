...
import type { NonEvmSourceJournal, NonEvmSourceJournalV3 } from "./non-evm-source-journal.js";
...
interface CircleV2SourceExecutionPorts {
...
interface CircleV2SourceExecutionIntent {
...
interface CircleV2SourceSubmission {
...
async function submitCircleV2BaseSourceBurnLive(intent: CircleV2SourceExecutionIntent,

...
export class BridgeService {
  ...
  async prepare(input: Parameters<BridgePreparation["prepare"]>[0]) {
  ...
  async status(operationId: string) { return await this.locked(operationId, async (op) => publicBridgeOperation(op)); }

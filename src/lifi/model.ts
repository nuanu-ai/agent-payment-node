...
export type BridgeDestinationTransactionProof = Pick<BridgeTransactionProof,
  "chainId" | "transactionHash" | "block" | "safeBlock" | "rpcOrigin" | "from" | "to" | "nonceAtomic" |
  "valueAtomic" | "dataHash" | "gasLimitAtomic" | "maxFeePerGasAtomic" | "maxPriorityFeePerGasAtomic" |
  "status" | "logsHash">;

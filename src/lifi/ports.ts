...
export interface BridgeRpcPort {
  ...
  observe(transactionHash: Hex, expected?: BridgeEnvelope, nativeDelivery?: Readonly<{ recipient: Address; from: Address; amountAtomic?: string; minimumAmountAtomic?: string }>): Promise<{

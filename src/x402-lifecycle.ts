...
export class X402Lifecycle {
  ...
  protected async beginPaidAttempt(
  ...
  protected async finishPaidAttempt(
    operation: X402OperationRecord,
  ...
  protected async markInterruptedPaidAttempt(
    operation: X402OperationRecord,
  ...
  protected async persistAndLinkResult(
    operation: X402OperationRecord,
  ...
  protected async recoverOrphanResult(operation: X402OperationRecord): Promise<X402OperationRecord> {
  ...
  protected async finishReconciledEvidence(operation: X402OperationRecord): Promise<X402OperationRecord> {
  ...
  protected async recoverOrphanReceipt(operation: X402OperationRecord): Promise<X402OperationRecord | null> {
  ...
  protected async commitTerminal(
    operation: X402OperationRecord,
  ...
  protected async commitTerminalOperation(
    operation: X402OperationRecord,
    terminalState: X402TerminalState,

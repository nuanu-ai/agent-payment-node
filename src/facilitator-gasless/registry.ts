...
export const AVALANCHE_FACILITATOR = {
  ...
  token: "0xb97ef9ef8734c71904d8002f8b6bc66dd9c48a6e" as Address,
  tokenDomain: { name: "USD Coin", version: "2" },
  domainSeparator: "0xbbea200329a938bc3438984a49cb0732e66d66d7bd59c127abacc1710e77f7b3" as Hex,
  decimals: 6,
  facilitatorUrl: FACILITATOR_URL,
  facilitatorOrigin: new URL(FACILITATOR_URL).origin,
  facilitatorEndpointHash: sha256(FACILITATOR_URL),
  approvedSigners: ["0xc6699d2aada6c36dfea5c248dd70f9cb0235cb63"] as readonly Address[],
  ...
  authorizationStateSelector: keccak256(toHex("authorizationState(address,bytes32)")).slice(0, 10) as Hex,
} as const;

import { z } from "zod";
import { addressSchema, blockSchema, hashSchema, isoSchema, originSchema, ownerSchema, providerBindingSchema, uintSchema,
  wordSchema } from "../gasless/schema.js";
import { FACILITATOR_HISTORY_LIMIT, FACILITATOR_KIND, FACILITATOR_OPERATION_VERSION, FACILITATOR_POLICY,
  FACILITATOR_STATES } from "./operation-model.js";

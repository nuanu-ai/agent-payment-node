...
export const GASLESS_TERMINAL: readonly GaslessState[] = ["completed", "failed_before_effect", "failed_confirmed_revert", "failed_permissions_invalidated", "abandoned_unknown"];

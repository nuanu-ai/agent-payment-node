 ...
 */
export const SUNSWAP_V2_KEYLESS_MECHANISM_PIN: SwapMechanismPin = validateSwapMechanismPin({
...
export const SUNSWAP_V2_KEYLESS_PROTOCOL_REGISTRY: SwapProtocolRegistry = compileSwapProtocolRegistry({

 ...
 */
export class UniswapLocalOwnerAdmission implements GuardedSwapOwnerAdmissionPort, UniswapOwnerAdmissionPort {
  constructor(private readonly state: StateStore, private readonly policy: GuardedSwapPolicyResolver) {}

  async assert(operationValue: SwapOperationRecord): Promise<UniswapOwnerAdmission> {

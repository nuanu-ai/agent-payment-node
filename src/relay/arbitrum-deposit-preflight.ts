/** Read-only deposit boundary for a saved Relay Arbitrum operation. Never signs, sends, or admits execution. */
...
export interface RelayArbitrumDepositPreflightPorts {
...
export async function preflightRelayArbitrumDeposit(operation: RelayUnsignedOperation,
  active: ActiveAssetPolicy, publicAccount: string, dailyUsageAtomic: string, now: Date,
  ports: RelayArbitrumDepositPreflightPorts) {
  ...
  return Object.freeze({ kind: "relay_arbitrum_read_only_deposit_preflight" as const,
